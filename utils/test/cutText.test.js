...
describe("CutText", () => {
  ...
  }); // Założenie brzmi: jeśli maxLength jest mniejsze od zera lub równe zero, to funkcja powinna zwrócić Error. Miało nie przejsc testu a przechodzi...
  ...
  }); // tu miala dzialac poprawnie a nie dziala...
